      ...
      child: Scaffold(
        body: Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(image: AssetImage(AppImages.backForgetPass),fit: BoxFit.fill),
          ),
          child: Padding(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(child: CustomText(text:LocaleKeys.enterEmail.tr(), color: AppColor.primaryColor,size: AppFonts.t8)),
                  ...
                  Center(child: AuthCustomBtn(text: LocaleKeys.sent.tr(),ontap: (){
                    Navigator.pushNamed(context, AppRoutes.confirmCodePass);
                  },)),
